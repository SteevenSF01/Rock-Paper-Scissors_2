...
function App() {
  ...
  return (
    <>
      ...
      {navigation == "home" ? (
          <div className="w-[90%] h-[55%] md:w-[600px] md:h-[380px] md:mt-10 md:p-0 px-5 mt-8  mx-auto flex flex-wrap justify-between md:justify-around p-2 containerMain  xl:h-[550px] xl:mt-[50px] xl:w-[750px] xl:pb-10  ">
      ...
      <div className=" flex justify-center md:absolute md:right-[50px] md:bottom-[50px] ">
        <button
          ...
          className="py-1 px-8 border-[#606e85] rounded-lg border-2 mt-3 text-white xl:py-3 xl:px-16 xl:text-[25px] "
        >
          {" "}
          Rules{" "}
        </button>

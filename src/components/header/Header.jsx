...
export default function Header(props) {
  // console.log(props);
  return (
    <div className='border-2 mx-auto  border-[#606e85] mt-[40px] rounded-xl md:w-[30rem] md:mt-[20px] w-[20rem] h-[7rem] flex justify-between items-center p-4 xl:mt-[20px] xl:w-[50rem] xl:h-[9rem] xl:border-4 '>
        <img src={Logo} alt="" className='w-[33%] h-[80%] md:w-[25%] xl:w-[22%] xl:h-[90h%] ' />
